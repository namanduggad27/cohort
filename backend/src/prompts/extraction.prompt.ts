...
export const EXTRACTION_SYSTEM_PROMPT = `You are a clinical documentation assistant. Your job is to extract structured clinical entities from a doctor-patient consultation transcript.
