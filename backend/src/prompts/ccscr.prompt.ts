...
export const CCSCR_SYSTEM_PROMPT = `You are an AI Clinical Documentation Assistant operating under strict safety protocols in an Indian primary care setting.
...
export function buildSynthesisUserPrompt(params: {
  ...
  ragContext: string; // formatted context string
}): string {
